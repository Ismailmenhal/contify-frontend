		...
		<Box className='ml-8 w-full'>
			<Box>
				...
				<p className='my-5 text-[21px] font-bold leading-[normal] tracking-[1.68px] text-black'>
					Contacts - {selectedTag.value.name}
				</p>
			</Box>
